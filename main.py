...
def MainScreen():
    ...
    if input_ == "update":
        ...
        print(CLR_CYAN + "    please confirm you want to your software y/n" + RESET_ALL)
    ...
    if input_ == "help":
        ...
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     Help             " + RESET_ALL + CLR_YELLOW + "Brings up the help section that you are viewing right now" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     about            " + RESET_ALL + CLR_YELLOW + "Brings up app info" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     website          " + RESET_ALL + CLR_YELLOW + "Sends you to my website" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     PassGen          " + RESET_ALL + CLR_YELLOW + "Downloads my program" + RESET_ALL + CLR_CYAN + " PassGen" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     exit(q)          " + RESET_ALL + CLR_YELLOW + "Closes app" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     update           " + RESET_ALL + CLR_YELLOW + "Downloads update files" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     time             " + RESET_ALL + CLR_YELLOW + "Brings up the time" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        print(CLR_CYAN + "\n     date             " + RESET_ALL + CLR_YELLOW + "Brings up the date" + RESET_ALL)
        print(CLR_WHİTE + "   __________________________________________________________________________________________________________________" + RESET_ALL)
        time.sleep(3)
        print(CLR_YELLOW + "\n  When you ready to go back to " + RESET_ALL + CLR_CYAN + "Main Menu " + RESET_ALL + CLR_YELLOW + "press 'Y' " + RESET_ALL)
        input__ = input("\n ====> ")
